...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Gtajisan/ToxicBomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/Gtajisan/ToxicBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd ToxicBomber && python frn-Bomber")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Gtajisan Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Gtajisan \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Gtajisan              \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mfrn-Bomber\n")
        time.sleep(0.6)
